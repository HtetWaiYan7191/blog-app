...
RSpec.describe 'Post show' do
    before :each do
        @user = User.create(name: 'Htet', photo: 'https://picsum.photos/id/23/200', bio: 'web developer', post_counter: 0)
        @post1 = Post.create(author_id: @user.id, title: 'Hello Rails', text: 'first post', like_counter: 0, comment_counter: 0)
        @post2 = Post.create(author_id: @user.id, title: 'Hello World', text: 'second post', like_counter: 0, comment_counter: 0)
        @post3 = Post.create(author_id: @user.id, title: 'Hello Ruby', text: 'third post', like_counter: 0, comment_counter: 0)
